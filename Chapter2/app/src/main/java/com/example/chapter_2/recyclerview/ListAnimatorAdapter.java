 ...
 * desc   :
 */
public class ListAnimatorAdapter extends RecyclerView.Adapter<ListAnimatorViewHolder> {

    private List<Data> mDataList = new ArrayList<>();

    @NonNull @Override public ListAnimatorViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return ListAnimatorViewHolder.create(viewGroup.getContext(), viewGroup);
    }

    @Override public void onBindViewHolder(@NonNull ListAnimatorViewHolder listViewHolder, int i) {
        listViewHolder.bind(mDataList.get(i), i);
    }
